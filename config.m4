...
if test "$PHP_HESSIAN" != "no"; then
  ...
  PHP_NEW_EXTENSION(hessian, hessian.c  php_dubbo_client.c dubbo_storage.c dubbo_service.c hessian_buffered_stream.c hessian_callback_handler.c hessian_client.c hessian_factory.c hessian_parsing.c hessian_interface.c hessian_options.c hessian_reference_map.c hessian_service.c hessian_stream.c hessian_transport.c hessian_type_map.c hessian_utils.c hessian2_iterator_writer.c hessian2_parser.c hessian2_service_parser.c hessian2_service_writer.c hessian_exception.c hessian2_writer.c, $ext_shared)
fi
